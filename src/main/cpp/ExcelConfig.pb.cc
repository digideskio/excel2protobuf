...
void protobuf_AssignDesc_ExcelConfig_2eproto() {
  protobuf_AddDesc_ExcelConfig_2eproto();
  ...
  static const int ExcelConfig_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExcelConfig, biyunlevels_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_ExcelConfig_2eproto);
}
...
void protobuf_AddDesc_ExcelConfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "nLevelB\021\n\017wang.gnim.excel", 105);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "ExcelConfig.proto", &protobuf_RegisterTypes);
  ExcelConfig::default_instance_ = new ExcelConfig();
  ExcelConfig::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_ExcelConfig_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_ExcelConfig_2eproto {
  StaticDescriptorInitializer_ExcelConfig_2eproto() {
    protobuf_AddDesc_ExcelConfig_2eproto();
  }
} static_descriptor_initializer_ExcelConfig_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int ExcelConfig::kBiyunLevelsFieldNumber;
#endif  // !_MSC_VER
...
const ExcelConfig& ExcelConfig::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ExcelConfig_2eproto();
        ...
        if (tag == 10) {
         parse_biyunLevels:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                input, add_biyunlevels()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(10)) goto parse_biyunLevels;
...
void ExcelConfig::SerializeWithCachedSizes(
  ...
  // repeated .biyunLevel biyunLevels = 1;
  for (int i = 0; i < this->biyunlevels_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->biyunlevels(i), output);
  }
...
int ExcelConfig::ByteSize() const {
  ...
  // repeated .biyunLevel biyunLevels = 1;
  total_size += 1 * this->biyunlevels_size();
  for (int i = 0; i < this->biyunlevels_size(); i++) {
    total_size +=
...
void ExcelConfig::MergeFrom(const ExcelConfig& from) {
  GOOGLE_CHECK_NE(&from, this);
  biyunlevels_.MergeFrom(from.biyunlevels_);
...
void ExcelConfig::Swap(ExcelConfig* other) {
  if (other != this) {
    biyunlevels_.Swap(&other->biyunlevels_);
